// lib/widgets/code_editor/advanced_file_tree.dart
import 'package:flutter/material.dart';
import 'dart:io';
import 'package:path/path.dart' as path;

class AdvancedFileTree extends StatefulWidget {
  final String projectPath;
  final Function(String) onFileSelected;
  final Function(String, String) onFileRenamed;
  final Function(String) onFileDeleted;
  final Function(String, bool) onFileCreated; // bool: isDirectory
  ...
  @override
  State<AdvancedFileTree> createState() => _AdvancedFileTreeState();
}

class _AdvancedFileTreeState extends State<AdvancedFileTree> {
